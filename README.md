## **DISCLAIMER: This repository is outdated and only exists as a legacy reference for the paper below. The current repository is [LLM-MusicTheory](https://github.com/liampond/LLM-MusicTheory)**
