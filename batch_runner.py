...
RCM5_QUESTIONS = [] # TODO
RCM6_QUESTIONS = ["Q1b", "Q2a", "Q2b", "Q3a", "Q3b", "Q3c", "Q3d", "Q3e", "Q4a", "Q4b", "Q5"]
...
if __name__ == "__main__":
    #Example call: python batch_runner.py --exam RCM6 --context NoContext --model ChatGPT --examdate August2024
